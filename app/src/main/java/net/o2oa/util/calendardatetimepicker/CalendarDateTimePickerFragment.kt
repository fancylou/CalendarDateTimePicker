...
class CalendarDateTimePickerFragment : DialogFragment() , OnDateSelectedListener, OnMonthChangedListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        dateTimePickerLayout.clone(activity, R.layout.fragment_calendar_picker2)
    ...
    private fun showStartDateCalendar() {
        ...
        tv_start_date.setTextColor(ContextCompat.getColor(activity!!, R.color.highlight_blue))
        tv_end_date.setTextColor(ContextCompat.getColor(activity!!, R.color.text_primary))
    ...
    private fun showEndDateCalendar() {
        ...
        tv_start_date.setTextColor(ContextCompat.getColor(activity!!, R.color.text_primary))
        tv_end_date.setTextColor(ContextCompat.getColor(activity!!, R.color.highlight_blue))
    ...
    private fun animationForCalendarVisible() {
        ...
        if (activity != null) {
            tv_start_date.setTextColor(ContextCompat.getColor(activity!!, R.color.highlight_blue))
            tv_time_value.setTextColor(ContextCompat.getColor(activity!!, R.color.text_primary))
        }
    }
    ...
    private fun animationForTimePickerVisible() {
        ...
        // tv_second_value 高亮
        tv_start_date.setTextColor(ContextCompat.getColor(activity!!, R.color.text_primary))
        tv_time_value.setTextColor(ContextCompat.getColor(activity!!, R.color.highlight_blue))
    }
